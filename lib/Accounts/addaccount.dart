...
import 'package:money1app/sqlite.dart';
...
class _AddaccountState extends State<Addaccount> {
  ...
  _addNewAccount()async {
    if(account_name==""){
      _scaffolkey.currentState.showSnackBar(SQLite.errorToast("please enter your account name"));
    }else if(account_balence==""){
      _scaffolkey.currentState.showSnackBar(SQLite.errorToast("please enter starting balance"));
